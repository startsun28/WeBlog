<template>
  <main class="container p-4">
    <div class="grid grid-cols-4 gap-7">
      ...
      <!-- 分类数 -->
      <div class="col-span-4 md:col-span-1 bg-green-500">
        <el-card class="box-card">
          <div class="flex items-center w-full h-full px-5 py-7 mb-5 bg-white dark:bg-gray-800">
      ...
      <!-- 标签数 -->
      <div class="col-span-4 md:col-span-1 bg-orange-500">
        <el-card class="box-card">
          <div class="flex items-center w-full h-full px-5 py-7 mb-5 bg-white dark:bg-gray-800">
      ...
      <!-- 总浏览量 -->
      <div class="col-span-4 md:col-span-1 bg-teal-500">
        <el-card class="box-card">
          <div class="flex items-center w-full h-full px-5 py-7 mb-5 bg-white dark:bg-gray-800">
      ...
      <!-- 文章发布热点图 -->
      <div class="col-span-4 md:col-span-2 bg-blue-500">
        <el-card class="box-card">
      ...
      <!-- 文章日 PV 访问量折线图 -->
      <div class="col-span-4 md:col-span-2 bg-indigo-500">
        <el-card class="box-card">
          <div class="w-full h-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
