<template>
  <div class="grid grid-cols-2 h-screen">
    <div class="col-span-2 order-2 md:col-span-1 md:order-1 bg-gray-200 dark:bg-gray-600">
      <!-- 指定为 flex 布局，并设置为屏幕垂直水平居中，高度为 100% -->
      <div class="flex justify-center items-center h-full animate__animated animate__bounceInLeft animate__fast">
        <img src="@/assets/images/preview.jpg" class=" w-3/4 object-fill rounded-lg">
      </div>
    </div>
